...
const BottomSheetModalDetached = forwardRef<Ref, Props>((props, ref) => {
  ...
  return (
    ...
    >
      <View style={styles.bottomSheet_content}>
        ...
        <Text style={styles.text}>Hey, i am detached bottom sheet modal</Text>
      </View>
    </BottomSheetModal>
  )
})
...
export default memo(BottomSheetModalDetached)
